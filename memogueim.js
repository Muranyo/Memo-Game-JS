...
function Carta(a,b) {
    ...
    if(document.getElementById(90).innerHTML==0){
        alert("PERDISTE CAPO CHAU SORI PRRI");

    }
    else if (elementosencontrados==8){
        alert("GANASTE CAPO CAMPEON DE LAS PRADERAS CAPO SUERTE PERRO ANDA A DISNEY TE VAS GRATIS GANASTE UN PASAJE MAQUINOLA NOS VIMOS ALLA EN DISNEY NOS VIMOS EN DISNEY");
    }
    else {
